...
class NotoriousBot(commands.Bot):
    def __init__(self):
        ...
        # In-memory data stores (would use DB in production)
        ...
        self.log_channels: Dict[int, Dict[str, int]] = {}  # guild_id -> {log_type: channel_id}
        ...
        # Fun games
        self.guess_games: Dict[int, int] = {}  # channel_id -> target_number
        ...
        # Load warns from file if exists
        try:
